...
//        }
        ...
        if (remoteMessage.getData() != null) {
            if (remoteMessage.getData().get("title").equals("تعليق جديد")) {
                String Ntitle = remoteMessage.getData().get("title");
                String Nmessage = remoteMessage.getData().get("body");

            } else if (remoteMessage.getData().get("title").equals("رسالة جديدة")) {
                ...
                ChatMessagesResponseModel.Message message = new ChatMessagesResponseModel.Message();
                ...
                if (!(Integer.valueOf(sender_id) == MainActivity.user_data.getId())) {
